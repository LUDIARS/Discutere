...
<style>
 ...
 h1{font-size:18px;margin:0 0 4px} .sub{color:#8b94a3;font-size:13px;margin:0 0 18px}
 .bar{display:flex;gap:10px;margin-bottom:16px}
 button{border:0;border-radius:8px;padding:9px 16px;font-size:13px;cursor:pointer;background:#2a2f3a;color:#e6e6e6}
 button:hover{background:#353b48}
 button.primary{background:#2563eb;color:#fff} button.danger{background:#b91c1c;color:#fff}
 button.sm{padding:5px 11px;font-size:12px}
 table{width:100%;border-collapse:collapse;background:#161922;border-radius:10px;overflow:hidden}
 th,td{text-align:left;padding:10px 12px;border-bottom:1px solid #232733;font-size:13px}
 ...
 .muted{color:#6b7280}.pill{font-size:11px;color:#9aa3b2;background:#222633;border-radius:6px;padding:2px 7px}
