...
| Method | Path | Description |
|--------|------|------------|
| `GET` | `/api/groups/:workspaceId/monitors` | 監視チャネル一覧 |
| `POST` | `/api/groups/:workspaceId/monitors` | 監視チャネル追加 |
| `PUT` | `/api/groups/:workspaceId/monitors/:id` | 監視設定更新 |
| `DELETE` | `/api/groups/:workspaceId/monitors/:id` | 監視チャネル削除 |
